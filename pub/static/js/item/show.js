...
$(function(){
  ...
  function change_page(page_id){
      ...
      $(".page-edit-link").show();
      $("#page-content").attr("src" , "/page/show?page_id="+page_id);
      $("#edit-link").attr("href" , "/page/edit?item_id="+item_id+"&id="+page_id);
      ...
      $("#delete-link").attr("data-page_id" , page_id);
      history.replaceState(null, null, "http://"+window.location.host+"/item/show?id="+item_id+"&page_id="+page_id);
  }
